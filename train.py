...
flags.DEFINE_integer("hidden_size", 256, "Size of each model layer.")
...
def main():
    ...
    with tf.Session() as sess:
        ...
        source_train_file_path = data_processor.train_source_file
        target_train_file_path = data_processor.train_target_file
        source_test_file_path = data_processor.test_source_file
        target_test_file_path = data_processor.test_target_file
        print(source_train_file_path)
        print(target_train_file_path)

        # The length of train_set/test_set is the number of buckets.
        # train_set[bucket_id] contains the data that fits into that bucket id
